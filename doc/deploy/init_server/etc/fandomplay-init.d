...
# Author: Diego Dainese <ddainese@shado.tv>
#
...
do_stop()
{
	...
	start-stop-daemon --stop --verbose --retry=TERM/30/KILL/5 --pidfile $PIDFILE --name java
	RETVAL="$?"
	return "$RETVAL"
}
...
case "$1" in
  ...
  stop)
	...
	;;
  status)
	status_of_proc -p $PIDFILE "$DAEMON" "java" && exit 0 || exit $?
	;;
  #reload|force-reload)
	#
