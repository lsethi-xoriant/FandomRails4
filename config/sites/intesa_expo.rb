module Fandom
  class Application < Rails::Application
    register_fandom_site(
      id: 'intesa_expo', 
      domains: ['intesa-expo.fandom.localdomain', 'intesa-expo.live.fandomlab.com', 'intesa-expo.dev.fandomlab.com', 'intesa-expo.stage.fandomlab.com'],
      # TODO: enable these domains to go live
