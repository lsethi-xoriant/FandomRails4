...
module CacheKeysHelper
  ...
  def get_calltoactions_info_cache_key(calltoaction_ids, interactions_to_compute, user_id) 
    "calltoactions_info_#{calltoaction_ids}_interactions_#{interactions_to_compute}_#{user_id}"
  end
