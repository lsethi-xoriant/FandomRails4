...
class TriviaInteraction < ActionController::TestCase
  ...
  test "trivia interaction" do
    ...
    points_after_correct_answer = get_answer_points(starting_points, "Right")
    ...
    visit(cta_link)
    starting_points = get_user_points_from_single_call_to_action_page
    points_after_wrong_answer = get_answer_points(starting_points, "Wrong 1")
    ...
    visit(cta_link)
    starting_points = get_user_points_from_single_call_to_action_page
    points_after_wrong_answer = get_answer_points(starting_points, "Wrong 2")
